        ...
        <div className="about-container">
          <div className="about-hero-content">
            ...
            <p className="about-hero-subtitle">
              We're committed to helping you make smarter money decisions with clear, reliable, 
            ...
            <div className="services-list">
              <div className="service-item">
                ...
                <div className="service-content">
                  ...
                  <p className="service-item-text">
                    Learn how credit scores work, how to improve them, and how to maintain excellent credit 
              ...
              <div className="service-item">
                ...
                <div className="service-content">
                  ...
                  <p className="service-item-text">
                    Find the best credit cards for your needs, understand rewards programs, and learn how to 
              ...
              <div className="service-item">
                ...
                <div className="service-content">
                  ...
                  <p className="service-item-text">
                    Get proven strategies to pay off debt faster, avoid common pitfalls, and regain control 
                    of your finances.
                  </p>
                </div>
              </div>
              <div className="service-item">
                ...
                <div className="service-content">
                  ...
                  <p className="service-item-text">
                    Stay informed about economic trends, investment opportunities, and how market changes 
