...
const Blog = () => {
  const blogPosts = [
    {
      ...
      excerpt:
        "Home price trends in major cities, growing inventory, mortgage availability, and whether buyers should act now or wait.",
      author: "Housing Desk",
      readTime: "7 min read",
    ...
    },
    {
      ...
      excerpt:
        "An in-depth look at the AI-driven rally, market winners, valuation risks, and analyst predictions for 2025-26.",
    ...
    },
    {
      ...
      excerpt:
        "Compare current APYs, top banks, online vs traditional options, and smart saving strategies.",
    ...
    },
    {
      ...
      excerpt:
        "EV manufacturing, chip fabs, robotics, government incentives, and top industrial stocks & ETFs.",
    ...
    {
      title:
        "Crypto Adoption Surges in the U.S.: Will Bitcoin Become Mainstream by 2026?",
      excerpt:
        "U.S. crypto regulations, Bitcoin ETF performance, adoption trends, and best practices for new investors.",
    ...
    {
      title:
        "The Student Loan Crisis Continues: What Borrowers Need to Know in 2025",
      excerpt:
        "Federal repayment updates, SAVE plan changes, forgiveness rules, and strategies for managing debt.",
    ...
    },
    {
      ...
      excerpt:
        "A breakdown of sticky inflation across housing, groceries, insurance, and healthcare, and what relief may come.",
    ...
    {
      title:
        "The Rise of AI Jobs in the U.S.: How It Will Change Income & Careers",
      excerpt:
        "Top-paying AI jobs, skills Americans should learn, automation risks, and job security through 2030.",
    ...
    },
    {
      ...
      excerpt:
        "From maximizing retirement accounts to preparing for market volatility, a practical financial checklist.",
      author: "Money Guide",
  ...
  const featuredPost = {
    ...
    excerpt:
      "Expected Fed rate cuts, mortgage and credit card rate changes, loan trends, and what U.S. consumers should do now.",
      ...
      <div className="blog-container">
        <div className="blog-header">
          ...
          <p className="section-description">
            Market trends, economic analysis, and smart money strategies for
            Americans
          </p>
        </div>
